...
async def agui_endpoint(input_data: RunAgentInput, request: Request):
    ...
    async def event_generator():
        ...
        try:
            response = await chat_agent.generate_rich_response(input_data.messages)
        ...
        # Los visuales viajan como eventos AG-UI CUSTOM para mantener intacto
        # el canal de texto y evitar acoplar el backend a un componente React.
